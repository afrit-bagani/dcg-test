...
class UpdateBasicInfoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'reg_no' => 'required|string|max:100|unique:student_basic_information,reg_no,' . $id . ',student_id',
            ...
            'aadhaar_no' => 'required|string|unique:student_basic_information,aadhaar_no,' . $id . ',student_id',
            'nationality' => 'required|string',
            'domicile' => 'required|string',
            'mobile_no' => 'required|string|max:20',
            'email' => 'required|email|unique:student_basic_information,email,' . $id . ',student_id',
