                    ...
                    @foreach ($students as $student)
                        <tr class="transition-all duration-300 ease-in-out hover:bg-slate-50 bg-white">
                            ...
                            <td class="py-3 px-4">
                                <div class="flex items-center gap-4">
                                    ...
                                    <a href="{{ route('admin.student.basic_info.edit', $student->student_id) }}"
                                        ...
                                        title="Edit Student Record"><i class="fas fa-edit text-base"></i></a>
                                </div>
                            </td>
                            ...
                            <td class="py-3 px-4">
                                ...
                                @else
                                    <span
                                        class="text-xs text-amber-500 italic bg-amber-50 px-2 py-1 rounded border border-amber-200">Pending
                                        Assignment</span>
                                @endif
                            </td>
                            <td class="py-3 px-4">
