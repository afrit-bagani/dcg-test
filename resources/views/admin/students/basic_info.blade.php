<x-admin-layout>
    ...
    <div class="bg-white shadow-sm border border-gray-200 rounded-lg overflow-hidden">
        ...
        <div class="flex border-b border-gray-200 bg-gray-50 overflow-x-auto">
            ...
            @else
                <div
                    class="px-6 py-4 text-gray-400 font-bold text-sm border-l border-gray-200 cursor-not-allowed flex items-center gap-2"
        ...
        <form method="POST"
            ...
            <div class="border border-yellow-200 rounded-lg bg-yellow-50/70 p-6">
                <div class="flex justify-between items-center border-b border-dashed border-yellow-300 pb-3 mb-5">
                    ...
                    <a href="#" class="text-sm font-bold text-blue-600 hover:underline">Don't have ABC ID / APAAR Id?
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-x-6 gap-y-5">
                    ...
                    <div>
                        <label class="block text-xs font-bold text-gray-700 mb-1">First Name <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        ...
                        <select name="gender" required
                                class="border border-blue-200 w-full p-2 rounded outline-none focus:ring-2 focus:ring-purple-500 text-sm bg-white">
                            <option
                                value="Female" {{ (old('gender', $student->gender ?? '') == 'Female') ? 'selected' : '' }}>
                                Female
                            </option>
                            <option
                                value="Male" {{ (old('gender', $student->gender ?? '') == 'Male') ? 'selected' : '' }}>
                                Male
                            </option>
                        </select>
                    </div>
                    ...
                    <div>
                        <label class="block text-xs font-bold text-gray-700 mb-1">Aadhaar No <span class="text-red-500">*</span></label>
                        <input type="text" name="aadhaar_no" value="{{ old('aadhaar_no', $student->aadhaar_no ?? '') }}"
                               required
                               class="border border-blue-200 w-full p-2 rounded outline-none focus:ring-2 focus:ring-purple-500 text-sm bg-white">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <select name="religion"
                                class="border border-blue-200 w-full p-2 rounded outline-none focus:ring-2 focus:ring-purple-500 text-sm bg-white">
                            <option
                                value="Islam" {{ (old('religion', $student->religion ?? '') == 'Islam') ? 'selected' : '' }}>
                                Islam
                            </option>
                            <option
                                value="Hindu" {{ (old('religion', $student->religion ?? '') == 'Hindu') ? 'selected' : '' }}>
                                Hindu
                            </option>
                            <option
                                value="Christian" {{ (old('religion', $student->religion ?? '') == 'Christian') ? 'selected' : '' }}>
                                Christian
                            </option>
                            <option
                                value="Sikh" {{ (old('religion', $student->religion ?? '') == 'Sikh') ? 'selected' : '' }}>
                                Sikh
                            </option>
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="category" required
                                class="border border-blue-200 w-full p-2 rounded outline-none focus:ring-2 focus:ring-purple-500 text-sm bg-white">
                            <option
                                value="OPEN" {{ (old('category', $student->category ?? '') == 'OPEN') ? 'selected' : '' }}>
                                OPEN
                            </option>
                            <option
                                value="OBC" {{ (old('category', $student->category ?? '') == 'OBC') ? 'selected' : '' }}>
                                OBC
                            </option>
                            <option
                                value="SC" {{ (old('category', $student->category ?? '') == 'SC') ? 'selected' : '' }}>
                                SC
                            </option>
                            <option
                                value="ST" {{ (old('category', $student->category ?? '') == 'ST') ? 'selected' : '' }}>
                                ST
                            </option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="marital_status"
                            ...
                            <option
                                value="Single" {{ (old('marital_status', $student->marital_status ?? '') == 'Single') ? 'selected' : '' }}>
                                Single
                            </option>
                            <option
                                value="Married" {{ (old('marital_status', $student->marital_status ?? '') == 'Married') ? 'selected' : '' }}>
                                Married
                            </option>
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="is_blind"
                                class="border border-blue-200 w-full p-2 rounded outline-none bg-white text-sm">
                            <option
                                value="0" {{ (old('is_blind', $student->is_blind ?? '') == '0') ? 'selected' : '' }}>No
                            </option>
                            <option
                                value="1" {{ (old('is_blind', $student->is_blind ?? '') == '1') ? 'selected' : '' }}>Yes
                            </option>
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="is_ph"
                                class="border border-blue-200 w-full p-2 rounded outline-none bg-white text-sm">
                            <option value="0" {{ (old('is_ph', $student->is_ph ?? '') == '0') ? 'selected' : '' }}>No
                            </option>
                            <option value="1" {{ (old('is_ph', $student->is_ph ?? '') == '1') ? 'selected' : '' }}>Yes
                            </option>
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="is_bpl"
                                class="border border-blue-200 w-full p-2 rounded outline-none bg-white text-sm">
                            <option value="0" {{ (old('is_bpl', $student->is_bpl ?? '') == '0') ? 'selected' : '' }}>
                                No
                            </option>
                            <option value="1" {{ (old('is_bpl', $student->is_bpl ?? '') == '1') ? 'selected' : '' }}>
                                Yes
                            </option>
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="is_minority"
                                class="border border-blue-200 w-full p-2 rounded outline-none bg-white text-sm">
                            <option
                                value="0" {{ (old('is_minority', $student->is_minority ?? '') == '0') ? 'selected' : '' }}>
                                No
                            </option>
                            <option
                                value="1" {{ (old('is_minority', $student->is_minority ?? '') == '1') ? 'selected' : '' }}>
                                Yes
                            </option>
                        </select>
                    </div>
            ...
            <div class="border border-yellow-200 rounded-lg bg-yellow-50/70 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="space-y-4 border-r border-dashed border-yellow-300 pr-6">
                        ...
                        <div class="flex items-center gap-4"><label
                                class="w-32 text-xs font-bold text-gray-700 text-right">Address Line 1: <span
                                    class="text-red-500">*</span></label><input type="text" name="present_address_1"
                                                                                value="{{ old('present_address_1', $student->present_address_1 ?? '') }}"
                                                                                required
                        ...
                        <div class="flex items-center gap-4"><label
                                class="w-32 text-xs font-bold text-gray-700 text-right">City: <span
                                    class="text-red-500">*</span></label><input type="text" name="present_city"
                                                                                value="{{ old('present_city', $student->present_city ?? '') }}"
                                                                                required
                                                                                class="flex-1 border border-yellow-400 p-2 rounded text-sm outline-none focus:ring-2 focus:ring-purple-500 bg-white">
                        </div>
                        <div class="flex items-center gap-4"><label
                        ...
                        <div class="flex items-center gap-4"><label
                                class="w-32 text-xs font-bold text-gray-700 text-right">State: <span
                                    class="text-red-500">*</span></label><input type="text" name="present_state"
                                                                                value="{{ old('present_state', $student->present_state ?? '') }}"
                                                                                required
                        ...
                        <div class="flex items-center gap-4"><label
                                class="w-32 text-xs font-bold text-gray-700 text-right">District: <span
                                    class="text-red-500">*</span></label><input type="text" name="present_district"
                                                                                value="{{ old('present_district', $student->present_district ?? '') }}"
                                                                                required
                                                                                class="flex-1 border border-gray-300 p-2 rounded text-sm outline-none focus:ring-2 focus:ring-purple-500 bg-white">
                        </div>
                        <div class="flex items-center gap-4"><label
                                class="w-32 text-xs font-bold text-gray-700 text-right">PIN: <span class="text-red-500">*</span></label><input
                                type="text" name="present_pin"
                    ...
                    <div class="space-y-4 pl-2">
                        ...
                        <div class="flex items-center gap-4"><label
                                class="w-32 text-xs font-bold text-gray-700 text-right">Address Line 1: <span
                                    class="text-red-500">*</span></label><input type="text" id="perm_addr_1"
                                                                                ...
                                                                                value="{{ old('permanent_address_1', $student->permanent_address_1 ?? '') }}"
                                                                                required
                                                                                class="flex-1 border border-yellow-400 p-2 rounded text-sm outline-none focus:ring-2 focus:ring-purple-500 bg-white">
                        </div>
                        <div class="flex items-center gap-4"><label
                        ...
                        <div class="flex items-center gap-4"><label
                                class="w-32 text-xs font-bold text-gray-700 text-right">City: <span
                                    class="text-red-500">*</span></label><input type="text" id="perm_city"
                                                                                name="permanent_city"
                                                                                value="{{ old('permanent_city', $student->permanent_city ?? '') }}"
                                                                                required
                                                                                class="flex-1 border border-yellow-400 p-2 rounded text-sm outline-none focus:ring-2 focus:ring-purple-500 bg-white">
                        </div>
                        <div class="flex items-center gap-4"><label
                                class="w-32 text-xs font-bold text-gray-700 text-right">Country: <span
                                    class="text-red-500">*</span></label><input type="text" id="perm_country"
                                                                                name="permanent_country" value="India"
                                                                                readonly
                                                                                class="flex-1 border border-gray-300 p-2 rounded text-sm outline-none bg-gray-50 text-gray-500">
                        </div>
                        <div class="flex items-center gap-4"><label
                                class="w-32 text-xs font-bold text-gray-700 text-right">State: <span
                                    class="text-red-500">*</span></label><input type="text" id="perm_state"
                                                                                ...
                                                                                value="{{ old('permanent_state', $student->permanent_state ?? '') }}"
                                                                                required
                                                                                class="flex-1 border border-gray-300 p-2 rounded text-sm outline-none focus:ring-2 focus:ring-purple-500 bg-white">
                        </div>
                        <div class="flex items-center gap-4"><label
                        ...
                        <div class="flex items-center gap-4"><label
                                class="w-32 text-xs font-bold text-gray-700 text-right">PIN: <span class="text-red-500">*</span></label><input
                                type="text" id="perm_pin" name="permanent_pin"
            ...
            <div class="border border-yellow-200 rounded-lg bg-yellow-50/70 p-6">
                <div class="border-b border-dashed border-yellow-300 pb-3 mb-5">
                    <h3 class="text-lg font-extrabold text-gray-800">Details about Qualified / Previous Examination</h3>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4">
                    <div class="flex items-center gap-4"><label class="w-48 text-xs font-bold text-gray-700">Admission
                            ...
                            <option
                                value="Regular" {{ (old('admission_type', $student->admission_type ?? '') == 'Regular') ? 'selected' : '' }}>
                                Regular
                            </option>
                        </select></div>
                    <div class="flex items-center gap-4"><label class="w-32 text-xs font-bold text-gray-700">Month/Year
                    ...
                    <div class="flex items-center gap-4"><label class="w-48 text-xs font-bold text-gray-700">Name of
                            Examination <span class="text-red-500">*</span></label><input type="text" name="exam_name"
                                                                                          value="{{ old('exam_name', $student->exam_name ?? '') }}"
                                                                                          class="flex-1 border border-gray-300 p-2 rounded text-sm bg-white"
                                                                                          required></div>
                    <div class="flex items-center gap-4"><label class="w-32 text-xs font-bold text-gray-700">Name of
                            Institution <span class="text-red-500">*</span></label><input type="text"
                                                                                          ...
                                                                                          class="flex-1 border border-blue-200 p-2 rounded text-sm bg-white"
                                                                                          required></div>
                    <div class="flex items-center gap-4"><label class="w-48 text-xs font-bold text-gray-700">Board /
                            University Type <span class="text-red-500">*</span></label><input type="text"
                                                                                              name="board_type"
                                                                                              value="{{ old('board_type', $student->board_type ?? '') }}"
                                                                                              class="flex-1 border border-gray-300 p-2 rounded text-sm bg-white"
                                                                                              required></div>
                    <div class="flex items-center gap-4"><label class="w-32 text-xs font-bold text-gray-700">Board Name
                            <span class="text-red-500">*</span></label><input type="text" name="board_university_name"
    ...
    <script>
        ...
        const inputs = ['surname', 'first_name', 'middle_name'].map(name => document.querySelector(`input[name="${name}"]`));
        const fullNameInput = document.querySelector('input[name="full_name"]');

        inputs.forEach(input => {
            if (input) {
                input.addEventListener('input', () => {
                    fullNameInput.value = inputs.map(i => i.value.trim()).filter(Boolean).join(' ').toUpperCase();
                });
            }
        });
